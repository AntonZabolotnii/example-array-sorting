...
const { insertionSort, bubbleSort, quickSort, selectionSort } = require('./common/implementations');
...
writeFile(path.join('generated', 'sorted_selection.json'), selectionSortWithMeasures(copyArr(arr)));